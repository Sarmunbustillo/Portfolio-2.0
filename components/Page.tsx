...
:root {
    ...
    --font-size-7: 4.8rem;
    --font-size-8: 5.6rem;
    --font-size-fluid-0: clamp(var(--font-size-0), 2vw, var(--font-size-1));
    --font-size-fluid-1: clamp(var(--font-size-2), 4vw, var(--font-size-4));
    --font-size-fluid-2: clamp(var(--font-size-4), 6vw, var(--font-size-6));
    --font-size-fluid-3: clamp(var(--font-size-5), 9vw, var(--font-size-7));
  ...
  /* sizes */
    ...
    --size-14: 32rem;
    --size-15: 48rem;
    --size-fluid-1: clamp(var(--size-2) 1vw, var(--size-3));
    --size-fluid-2: clamp(var(--size-2), 2vw, var(--size-5));
    --size-fluid-3: clamp(var(--size-5), 3vw, var(--size-7));
    --size-fluid-4: clamp(var(--size-7), 4vw, var(--size-8));
    --size-fluid-5: clamp(var(--size-9) 5vw, var(--size-10));
    --size-fluid-6: clamp(var(--size-10), 7vw, var(--size-11));
    --size-fluid-7: clamp(var(--size-11), 10vw, var(--size-12));
    --size-fluid-8: clamp(var(--size-12), 20vw, var(--size-13));
    --size-fluid-9: clamp(var(--size-13), 30vw, var(--size-14));
    --size-fluid-10: clamp(var(--size-14) 40vw, var(--size-15));
      ...
      --orange-9: #d9480f;
       ...
       --linear-gradient-1: linear-gradient(var(--gradient-direction),var(--cyan-4),var(--pink-4));
       --linear-gradient-2: linear-gradient(to bottom, var(--pink-4), var(--violet-4), var(--indigo-4), var(--cyan-4));
  ...
  *, *::before, *::after {
  ...
  h3 {font-size: var( --font-size-fluid-2)};
